...
void setup() {
  ...
  Serial.println("MPU-6050 attatched");
...
void loop() {
  ...
  accelerationAngleZ = (180 / 3.141592) * atan2(AcZ , sqrt(pow(AcY,2) + pow(AcX,2)));
  ...
  String outputString = String(angleY) + "," + millis() + "\n";
  XBee.print(outputString);
